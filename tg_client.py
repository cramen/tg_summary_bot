...
- На важные новости надо оставлять ссылки на изначальные сообщения/новости
...
Если для какого-то раздела нету данных, то вообще этот раздел не стоит писать. 
"""
